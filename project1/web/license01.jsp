      ...
      <div class="contents">
          ...
          <div class="inner">
              <div class="breadcrumb">
                  <p><a href="<%=path %>/">HOME</a> &gt; <a href="<%=path %>/license01.jsp">자격증</a> &gt; <span>정보처리기사</span></p>
              </div>
              <div class="content_wrap">
                  ...
                  <div>
                      ...
                      <div class="btn_group txt_center">
                          <a href="https://www.q-net.or.kr/crf005.do?id=crf00505&gSite=Q&gId=&jmCd=1320&examInstiCd=1" class="inBtn inBtn1" title="큐넷:정보처리기사" target="_blank">시험정보 바로가기</a>
                      </div>
                  </div>
              </div>
          </div>
